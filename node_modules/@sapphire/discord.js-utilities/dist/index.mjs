...
import { isNullish, partition, chunk, isFunction, deepClone, isObject } from '@sapphire/utilities';
  ...
  setUpCollector(channel, targetUser) {
    if (this.pages.length > 1) {
      this.collector = new InteractionCollector(targetUser.client, {
        ...
        interaction.isMessageComponent() && (this.actions.has(interaction.customId) || this.pageActions.some((actions) => actions && actions.has(interaction.customId))),
        time: this.idle,
